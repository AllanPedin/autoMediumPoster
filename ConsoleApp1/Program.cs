...
namespace ConsoleApp1
{
    public static class Program
    {
        public static void Main(string[] args)
        {
            ...
            medium.Post("Final test before deploy to git hub", "<p>Cache invalidation</p><p>Naming things</p>", "https://www.singlestoneconsulting.com/", "\"developmentals\", \"designerinos\"");
        }
    }
    public class MediumPoster
    {
        ...
        /*url=canonical url in string format (Example: https://www.singlestoneconsulting.com/ )*/
